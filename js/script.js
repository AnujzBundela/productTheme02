        ...
        <div class="row">
          ...
          <div class="col-lg-auto col-sm-6 mb-4 mb-md-0">
            ...
            <ul class="contact-info">
              ...
              <li>
                <a href="footer_contact" id="footer-contacts"> 
                  ...
                  </svg>  +91 <span id="footer-contact">70169 64352</span> </a>
              </li>
              <li>
...
fetch("https://script.google.com/macros/s/AKfycbzkGFsr2_TAL6aX7riCLZxjnHm8UfRUKgiuUaA-lKF6t9Z8OiHHpoMY6nGnsH-b78c8/exec")
  ...
  .then(data => {
    ...
    document.getElementById("footer-contact").innerHTML = data.footer_contact;

    // document.querySelector("#footer_contact span").innerHTML = data.footer_contact;
    document.getElementById("footer-contacts").href = `tel:${data.footer_contact}`;
